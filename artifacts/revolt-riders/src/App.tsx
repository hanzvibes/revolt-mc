    ...
    <div className="flex min-h-screen bg-[#080808]">
      ...
      <div className="relative flex flex-1 flex-col overflow-hidden min-w-0">
        <Switch>
          ...
          <Route path="/heatmap" component={() => <AttendanceHeatmap onMenuOpen={() => setMobileOpen(true)} />} />
          <Route path="/chapters" component={() => <ChapterLeaderboard onMenuOpen={() => setMobileOpen(true)} />} />
          <Route path="/compliance" component={() => <Compliance onMenuOpen={() => setMobileOpen(true)} />} />
